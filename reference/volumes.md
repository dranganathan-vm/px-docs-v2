...
`pxctl volume ha-update cancel` is a command that can be used to cancel an ongoing request to ha-update a volume NOTE: Volume may need to be in attached state for this operation.
